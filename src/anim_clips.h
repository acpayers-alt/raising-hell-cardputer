...
enum AnimId : uint16_t
{
  ...
  ANIM_ALIEN_BABY_HUNGRY_STAND,
  ANIM_ALIEN_BABY_SICK_MOAN,
  ANIM_ALIEN_BABY_SICK_SNEEZE,
  ANIM_ALIEN_BABY_BORED_IDLE,
  ANIM_ALIEN_BABY_BORED_BLINK,
  ANIM_ALIEN_BABY_ANGRY_STOMP,
  ANIM_ALIEN_BABY_ANGRY_POUNCE,
  ANIM_ALIEN_BABY_TIRED_LAY,
  ANIM_ALIEN_BABY_TIRED_HOLD,
  ...
  ANIM_ALIEN_TEEN_ANGRY_JUMP,
  ANIM_ALIEN_TEEN_ANGRY_SABER,
  ANIM_ALIEN_TEEN_HUNGRY_FORK,
  ANIM_ALIEN_TEEN_TIRED_SNORE,
  ANIM_ALIEN_TEEN_TIRED_BLINK,
  ANIM_ALIEN_TEEN_SICK_LOOP,

  // Alien (adult)
  ANIM_ALIEN_ADULT_HAPPY_STANCE,
  ANIM_ALIEN_ADULT_HAPPY_FLICK,
  ANIM_ALIEN_ADULT_BORED_SIGH,
  ANIM_ALIEN_ADULT_ANGRY_SHOOT,
  ...
  ANIM_ALIEN_ELDER_HAPPY_CAN,
  ANIM_ALIEN_ELDER_HAPPY_CAN_LEFT,
  ANIM_ALIEN_ELDER_BORED_BLINK,
  ANIM_ALIEN_ELDER_BORED_BEAM,
  ANIM_ALIEN_ELDER_ANGRY_SHAKE,
  ANIM_ALIEN_ELDER_TIRED_ROCK,
  ANIM_ALIEN_ELDER_HUNGRY_BEND,
  ANIM_ALIEN_ELDER_SICK_LAY,
};
